...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_FILE']._serialized_end=272
  _globals['_DHT']._serialized_start=275
  _globals['_DHT']._serialized_end=705
